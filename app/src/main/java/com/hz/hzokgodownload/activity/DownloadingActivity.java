...
import com.hz.hzokgodownload.base.BaseRecyclerAdapter;
import com.hz.hzokgodownload.base.DividerItemDecoration;
...
public class DownloadingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        folder = (TextView) findViewById(R.id.targetFolder);
