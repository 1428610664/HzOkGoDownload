package com.hz.hzokgodownload.adapter;
...
import com.hz.hzokgodownload.bean.ApkModel;
import com.hz.hzokgodownload.listener.LogDownloadListener;
import com.hz.hzokgodownload.utils.ApkUtils;
import com.hz.hzokgodownload.widget.NumberProgressBar;
...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            download = (Button) itemView.findViewById(R.id.start);
            ...
            itemView.findViewById(R.id.restart).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    restart();
                }
